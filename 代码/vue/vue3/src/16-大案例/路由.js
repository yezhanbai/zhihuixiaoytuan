...
import Films from '../16-大案例/views/Films.vue'
// import Cinemas from '../16-大案例/views/Cinemas.vue'
// import Center from '../16-大案例/views/Center.vue'
import NotFound from '../16-大案例/views/NotFound.vue'
import nowplaying from '../16-大案例/views/films/nowplaying.vue'
import comingsoon from '../16-大案例/views/films/comingsoon.vue'
import detail from '../16-大案例/views/Detail.vue'
import Login from '../16-大案例/views/Login.vue'
...
const routes = [
    ...
    {
        path: "/cinemas",
        component: () => import('../16-大案例/views/Cinemas.vue')      //上面静态导入，注释掉改成动态导入，实现懒加载，避免用户打开首页时，全部加载导致首页显示过慢
    },
    {
        path: "/center",
        component: () => import('../16-大案例/views/Center.vue'),
        meta: {
